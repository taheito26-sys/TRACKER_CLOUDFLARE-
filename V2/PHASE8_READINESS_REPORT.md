...
- Generated: 2026-03-15T01:56:22.731Z
...
```json
{
  ...
  "service": "p2p-tracker",
  "version": "unknown",
  "timestamp": "2026-03-15T01:56:17.561Z",
  "endpoints": [
    "/api/system/health",
...
```json
{
  "ok": true,
  "service": "p2p-tracker",
  "timestamp": "2026-03-15T01:56:17.608Z",
  "bindings": {
    "db": true,
    "kv": true,
    "dbCheck": true
...
```json
{
  ...
  "timestamp": "2026-03-15T01:56:19.913Z"
}
```
...
```json
{
  ...
  "timestamp": "2026-03-15T01:56:22.402Z"
}
```
...
```json
{
  ...
  "timestamp": "2026-03-15T01:56:23.742Z"
}
```
