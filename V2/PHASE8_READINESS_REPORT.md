...
- Generated: 2026-03-15T01:34:44.787Z
...
```json
{
  ...
  "service": "p2p-tracker",
  "version": "unknown",
  "timestamp": "2026-03-15T01:34:39.681Z",
  "endpoints": [
    "/api/system/health",
...
```json
{
  "ok": true,
  "service": "p2p-tracker",
  "timestamp": "2026-03-15T01:34:39.708Z",
  "bindings": {
    "db": true,
    "kv": true,
    "dbCheck": true
...
```json
{
  ...
  "timestamp": "2026-03-15T01:34:41.942Z"
}
```
...
```json
{
  ...
  "timestamp": "2026-03-15T01:34:44.399Z"
}
```
...
```json
{
  ...
  "timestamp": "2026-03-15T01:34:45.770Z"
}
```
